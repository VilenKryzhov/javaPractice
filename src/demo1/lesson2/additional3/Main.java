...
//// Штани (реалізує також інтерфейси Чоловічий одяг і Жіночий одяг), Плаття (реалізує інтерфейс "Жіночий одяг"), Галстук (реалізує інтерфейси Чоловічий одяг).
//
////5. Створити клас Ательє, який має полем масив об'єктів Одяг (тобто в ньому можуть бути об'єкти усіх класів-нащадків),
//// та 2 методи - чоловічий вибір (повертає увесь ЧОЛОВІЧИЙ одяг (підказка: instanceof оператор допоможе -> if(a instanceof X){...})) та жіночий вибір (повертає увесь ЖІНОЧИЙ одяг).